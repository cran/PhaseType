...
typedef struct envelope {  /* attributes of the entire rejection envelope */
  ...
  POINT p[100];                /* start of storage of envelope POINTs */
...

{
  ...
  ENVELOPE envS, *env;      /* rejection envelope */
  ...
  METROPOLIS metropS, *metrop; /* to hold bits for metropolis step */
  int i,err;
...
{
  double u,xl=0.0,xr=0.0,yl,yr,eyl,eyr,prop;
  POINT *q;
